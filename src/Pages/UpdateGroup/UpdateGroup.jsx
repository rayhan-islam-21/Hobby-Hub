...
const UpdateGroup = () => {
  ...
  const notify = () => toast.success("Group Updated Successfully");
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { resetForm }) => {
      ...
      // console.log("Group data to be updated:", groupData);
      // console.log("Update group with id:", params.id);
      fetch(`https://hobbyhub-server-ten.vercel.app/allgroups/${params.id}`, {
        method: "PUT",
        headers: {
